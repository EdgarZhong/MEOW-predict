...
PROJ_ROOT = ROOT.parent.parent  # experiments/legacy/ -> experiments/ -> MEOW--predict/
sys.path.insert(0, str(ROOT))           # 找同目录的 run_516v3_restricted
sys.path.insert(0, str(PROJ_ROOT / "src"))  # 找 experiment_runner 等核心模块
...
def main():
    ...
    runner = ExperimentRunner(str((PROJ_ROOT / "data").resolve()))
